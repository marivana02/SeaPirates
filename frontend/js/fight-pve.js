    ...
    npc.img = isWeeklyBoss ? 'assets/ui/weekly_boss.png' : (isTiamat ? 'assets/enemies/tiamat/sprite-256px-36_1.webp' : (isTowerMode ? tInit.img : (localStorage.getItem('sp_current_target_img') || '')));
