...
// Shop Catalog
const SHOP_ITEMS = {
   1:  { type: 'top',    name: '30 Pounder',             price: 7500,  currency: 'gold',  qty: 1 },
   2:  { type: 'top',    name: '55 Pounder',             price: 2000,  currency: 'pearl', qty: 1 },
   3:  { type: 'top',    name: '60 Pounder',             price: 6000,  currency: 'pearl', qty: 1 },
   10: { type: 'gulle',  name: 'Grapeshot (x100)',       price: 1500,  currency: 'gold',  qty: 100 },
   11: { type: 'gulle',  name: 'Hollow Shot (x100)',     price: 3000,  currency: 'gold',  qty: 100 },
   12: { type: 'gulle',  name: 'Explosive Shot (x100)',  price: 400,   currency: 'pearl', qty: 100 },
   20: { type: 'direk',  name: 'Wooden Beam',            price: 20000, currency: 'gold',  qty: 1 },
...
router.post('/buy', authMiddleware, async (req, res) => {
  ...
  try {
    ...
    await updateQuestProgress(pool, playerId, { type: 'buy', itemGroup: item.type, amount: qty }, client);
